<?php
/**
 * Big Lights functions and definitions
 *
...
if ( ! defined( 'BIG_LIGHTS_VERSION' ) ) {
	// Replace the version number of the theme on each release.
	$theme_data = wp_get_theme();
	define( 'BIG_LIGHTS_VERSION', $theme_data->get( 'Version' ) );
}
...
if ( ! function_exists( 'big_bob_setup' ) ) :
	...
	function big_bob_setup() {
		...
		register_nav_menus(
			array(
				'menu-1' => esc_html__( 'Navbar', 'big-lights' ),
				'menu-2' => esc_html__( 'Main Sidebar', 'big-lights' ),
				'menu-3' => esc_html__( 'Footer', 'big-lights' ),
				'menu-4' => esc_html__( 'Page Sidebar', 'big-lights' ),
			)
		);
...
function big_bob_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Main Sidebar 1', 'big-lights' ),
			'id'            => 'sidebar-1',
	...
	register_sidebar(
		array(
			'name'          => esc_html__( 'Main Sidebar 2', 'big-lights' ),
			'id'            => 'sidebar-2',
			...
			This will be set below the first sidebar.', 'big-lights' ),
			'before_widget' => '<section id="%1$s" class="widget %2$s">',
			'after_widget'  => '</section>',
			'before_title'  => '<h2 class="widget-title">',
			'after_title'   => '</h2>',
	...
	register_sidebar(
		array(
			'name'          => esc_html__( 'Page Sidebar 1', 'big-lights' ),
			'id'            => 'sidebar-3',
			...
			If a main sidebar menu is used, then the widgets (blocks) for this area will be featured below it.', 'big-lights' ),
			'before_widget' => '<section id="%1$s" class="widget %2$s">',
			'after_widget'  => '</section>',
			'before_title'  => '<h2 class="widget-title">',
			'after_title'   => '</h2>',
	...
	register_sidebar(
		array(
			'name'          => esc_html__( 'Page Sidebar 2', 'big-lights' ),
			'id'            => 'sidebar-4',
	...
	register_sidebar(
		array(
			'name'          => esc_html__( 'Footer', 'big-lights' ),
			'id'            => 'footer-1',
			'description'   => esc_html__( 'These widgets (blocks) will be entered into the footer at the bottom of the page.', 'big-lights' ),
			'before_widget' => '<section id="%1$s" class="widget %2$s">',
			'after_widget'  => '</section>',
			'before_title'  => '<h2 class="widget-title">',
			'after_title'   => '</h2>',
...
function big_bob_scripts() {
	wp_enqueue_style( 'big-lights-style', get_stylesheet_uri(), array(), BIG_LIGHTS_VERSION );
	wp_style_add_data( 'big-lights-style', 'rtl', 'replace' );
    $big_bob_prev_font_1 = "";
    $big_bob_prev_font_2 = "";
    $big_bob_prev_font_3 = "";
    if (get_theme_mod('big_bob_fonts_title', 'Special Elite') != "") {
        $big_bob_font = get_theme_mod('big_bob_fonts_title', 'Special Elite');
        ...
        wp_enqueue_style('big-lights-google-fonts', esc_url($big_bob_url), false);
        $big_bob_prev_font_1 = $big_bob_url;
    }
	if (get_theme_mod('big_bob_fonts_main_title', 'Special Elite') != "") {
        $big_bob_font = get_theme_mod('big_bob_fonts_main_title', 'Special Elite');
        $big_bob_font = trim($big_bob_font);
        $big_bob_font = str_replace(' ', '+', $big_bob_font);
        $big_bob_url = 'https://fonts.googleapis.com/css?family=';
        $big_bob_url .= $big_bob_font;
        if ($big_bob_url != $big_bob_prev_font_1) {
            wp_enqueue_style('big-lights-google-fonts-2', esc_url($big_bob_url), false);
        }
		$big_bob_prev_font_2 = $big_bob_url;
    }
    if (get_theme_mod('big_bob_fonts_paragraph', "Special Elite") != "") {
        $big_bob_font = get_theme_mod('big_bob_fonts_paragraph', "Special Elite");
        $big_bob_font = trim($big_bob_font);
        $big_bob_font = str_replace(' ', '+', $big_bob_font);
        $big_bob_url = 'https://fonts.googleapis.com/css?family=';
        $big_bob_url .= $big_bob_font;
        if (($big_bob_url != $big_bob_prev_font_1) && ($big_bob_url != $big_bob_prev_font_2)) {
            wp_enqueue_style('big-lights-google-fonts-3', esc_url($big_bob_url), false);
        }
		$big_bob_prev_font_3 = $big_bob_url;
    }
    if (get_theme_mod('big_bob_fonts_misc', 'Special Elite') != "") {
        $big_bob_font = get_theme_mod('big_bob_fonts_misc', 'Special Elite');
        $big_bob_font = trim($big_bob_font);
        $big_bob_font = str_replace(' ', '+', $big_bob_font);
        $big_bob_url = 'https://fonts.googleapis.com/css?family=';
        $big_bob_url .= $big_bob_font;
        if (($big_bob_url != $big_bob_prev_font_1) && ($big_bob_url != $big_bob_prev_font_2) && ($big_bob_url != $big_bob_prev_font_3)) {
            wp_enqueue_style('big-lights-google-fonts-4', esc_url($big_bob_url), false);
        }
    }
	wp_enqueue_style('big-bob-font-awesome', get_template_directory_uri() . '/vendor/fontawesome-free/css/all.min.css');
	wp_enqueue_script( 'big-bob-scripts-js', get_template_directory_uri() . '/js/big-lights-scripts.js?v=0.11', array('jquery'), '20160909', true );

	wp_enqueue_script( 'big-bob-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), BIG_LIGHTS_VERSION, true );
...
function big_bob_guten_enqueue() {
    wp_enqueue_script(
        ...
        get_template_directory_uri() . '/js/big-lights-guten.js?v=0.1',
		array( 'wp-blocks' )
    );
}
...
function big_bob_register_my_pattern_categories() {
	register_block_pattern_category(
		...
		array( 'label' => __( 'Cover', 'big-lights' ) )
	);
	register_block_pattern_category(
		'big_bob-nav-color-patterns',
		array( 'label' => __( 'Navbar Colors', 'big-lights' ) )
	);
	register_block_pattern_category(
		'big_bob-body-color-patterns',
		array( 'label' => __( 'Body Colors', 'big-lights' ) )
	);
	register_block_pattern_category(
		'big_bob-mixed-color-patterns',
		array( 'label' => __( 'Mixed Colors', 'big-lights' ) )
	);
	register_block_pattern_category(
		'big_bob-footer-patterns',
		array( 'label' => __( 'Footer', 'big-lights' ) )
	);
	register_block_pattern_category(
		'big_bob-images-text-patterns',
		array( 'label' => __( 'Images and Text', 'big-lights' ) )
	);
	register_block_pattern_category(
		'big_bob-text-patterns',
		array( 'label' => __( 'Text', 'big-lights' ) )
	);
	register_block_pattern_category(
		'big_bob-post-patterns',
		array( 'label' => __( 'Blog', 'big-lights' ) )
	);
}
...
function big_bob_register_my_patterns() {
	register_block_pattern(
		'big-lights/title-description-image-list-nav-colors',
		array(
			'title'      => __( 'Tile, Description, Image, and List in Nav Colors', 'big-lights' ),
			'categories' => array( 'big_bob-images-text-patterns' ),
			'content'    => '<!-- wp:group {"className":"bb-fun-palace bb-nav-colors"} -->
			<div class="wp-block-group bb-fun-palace bb-nav-colors"><!-- wp:spacer {"height":"50px"} -->
			...
			<!-- wp:heading {"style":{"typography":{"textTransform":"uppercase","fontSize":"60px"}},"className":"bb-fun-palace-heading"} -->
			<h2 class="bb-fun-palace-heading" style="font-size:60px;text-transform:uppercase">Big Bob\'s Fun Palace</h2>
			<!-- /wp:heading -->
			
			<!-- wp:paragraph {"fontSize":"x-large"} -->
			<p class="has-x-large-font-size">A place for people that are serious about fun.</p>
			<!-- /wp:paragraph --></div>
			<!-- /wp:column -->
			
			<!-- wp:column -->
			<div class="wp-block-column"><!-- wp:image {"id":845,"sizeSlug":"large","linkDestination":"none","style":{"color":{}},"className":"bb-fun-palace-image"} -->
			<figure class="wp-block-image size-large bb-fun-palace-image"><img src="' . esc_url(get_template_directory_uri()) .'/image/StockSnap_45VQJS6717GuitarWithHandx900.webp" alt="" class="wp-image-845"/></figure>
			<!-- /wp:image -->
			...
			<!-- wp:columns {"className":"bb-fun-palace-list"} -->
			<div class="wp-block-columns bb-fun-palace-list"><!-- wp:column {"className":"bb-fun-palace-inner-column"} -->
			<div class="wp-block-column bb-fun-palace-inner-column"><!-- wp:list {"style":{"typography":{"fontSize":"22px"}}} -->
			<ul style="font-size:22px"><li>Food</li><li>Drinks</li><li>Sports Bar</li><li>Arcade Games</li><li>Dancing</li></ul>
			<!-- /wp:list --></div>
			<!-- /wp:column -->
			
			<!-- wp:column {"className":"bb-fun-palace-inner-column"} -->
			<div class="wp-block-column bb-fun-palace-inner-column"><!-- wp:list {"style":{"typography":{"fontSize":"22px"}}} -->
			<ul style="font-size:22px"><li>Bowling</li><li>Live Music</li><li>Pool</li><li>Poker</li><li>Curling</li></ul>
			<!-- /wp:list --></div>
			<!-- /wp:column --></div>
			<!-- /wp:columns --></div>
			<!-- /wp:column --></div>
	...
	register_block_pattern(
		'big-lights/four-images-with-text-nav-colors',
		array(
			'title'      => __( 'Four Images with Navbar Colors', 'big-lights' ),
			...
			<div class="wp-block-group"><!-- wp:media-text {"mediaPosition":"right","mediaId":1003,"mediaLink":"' . esc_url(get_template_directory_uri()) .'/image/StockSnap_191P2Z8N6ICrowdSurf1800.webp","mediaType":"image"} -->
			<div class="wp-block-media-text alignwide has-media-on-the-right is-stacked-on-mobile"><figure class="wp-block-media-text__media"><img src="' . esc_url(get_template_directory_uri()) .'/image/StockSnap_191P2Z8N6ICrowdSurf1800.webp" alt="" class="wp-image-1003 size-full"/></figure><div class="wp-block-media-text__content"><!-- wp:heading -->
			<h2>Section Title</h2>
			<!-- /wp:heading -->
			...
			<!-- wp:columns -->
			<div class="wp-block-columns"><!-- wp:column -->
			<div class="wp-block-column"><!-- wp:heading {"textAlign":"center","placeholder":"Title","align":"center"} -->
			<h2 class="has-text-align-center">Title 1</h2>
			<!-- /wp:heading -->
			
			<!-- wp:image {"align":"center"} -->
			<figure class="wp-block-image aligncenter"><img src="' . esc_url(get_template_directory_uri()) .'/image/StockSnap_45VQJS6717GuitarWithHandx900.webp"alt=""/></figure>
			<!-- /wp:image -->
			...
			<!-- wp:column -->
			<div class="wp-block-column"><!-- wp:heading {"textAlign":"center","placeholder":"Title","align":"center"} -->
			<h2 class="has-text-align-center">Title 2</h2>
			<!-- /wp:heading -->
			
			<!-- wp:image {"align":"center"} -->
			<figure class="wp-block-image aligncenter"><img src="' . esc_url(get_template_directory_uri()) .'/image/StockSnap_Q0LOIKU7GMicrophone900.webp" alt=""/></figure>
			<!-- /wp:image -->
			...
			<!-- wp:column -->
			<div class="wp-block-column"><!-- wp:heading {"textAlign":"center","placeholder":"Title","align":"center"} -->
			<h2 class="has-text-align-center">Title 3</h2>
			<!-- /wp:heading -->
			
			<!-- wp:image {"align":"center"} -->
			<figure class="wp-block-image aligncenter"><img src="' . esc_url(get_template_directory_uri()) .'/image/StockSnap_LTYITHITMXBlueFireworks800.webp" alt=""/></figure>
			<!-- /wp:image -->
	...
	register_block_pattern(
		'big-lights/four-images-with-text-body-colors',
		array(
			'title'      => __( 'Four Images with Body Colors', 'big-lights' ),
	...
	register_block_pattern(
		'big-lights/image-collage-with-text-body-colors',
		array(
			'title'      => __( 'Image Collage with Body Colors', 'big-lights' ),
			'categories' => array( 'big_bob-body-color-patterns' ),
			...
			<figure class="wp-block-image size-large"><img src="' . esc_url(get_template_directory_uri()) .'/image/StockSnap_R2GG6XFPOMLightsOnTree900.webp" alt=""/></figure>
			<!-- /wp:image --></div>
			<!-- /wp:column -->
			...
			<figure class="wp-block-image size-large is-style-default"><img src="' . esc_url(get_template_directory_uri()) .'/image/StockSnap_9GN3TCBYFRVerticalFireworks900.webp" alt=""/></figure>
			<!-- /wp:image --></div>
			<!-- /wp:column --></div>
			<!-- /wp:columns -->
			...
			<figure class="wp-block-image alignright size-large"><img src="' . esc_url(get_template_directory_uri()) .'/image/StockSnap_LTYITHITMXBlueFireworks800.webp" alt=""/></figure>
			<!-- /wp:image --></div>
			<!-- /wp:column -->
	...
	register_block_pattern(
		'big-lights/image-collage-with-text-nav-colors',
		array(
			'title'      => __( 'Image Collage with Nav Colors', 'big-lights' ),
			'categories' => array( 'big_bob-nav-color-patterns' ),
	...
	register_block_pattern(
		'big-lights/forest-cover',
		array(
			'title'      => __( 'Large Cover Block', 'big-lights' ),
			'categories' => array( 'big_bob-cover-patterns' ),
			'content'    => '<!-- wp:cover {"url":"' . esc_url(get_template_directory_uri()) .'/image/StockSnap_191P2Z8N6ICrowdSurf1800.webp","dimRatio":60,"minHeight":800,"align":"full","className":"bb-forest-cover"} -->
			...
			<h2 class="alignwide has-text-align-left has-text-color" style="color:#ffe074;font-size:64px">Welcome to Big Lights</h2>
			<!-- /wp:heading -->
	...
	register_block_pattern(
		'big-lights/fuji-cover',
		array(
			'title'      => __( 'Cover Block with Images', 'big-lights' ),
			'categories' => array( 'big_bob-cover-patterns' ),
			...
			<figure class="wp-block-image size-large" style="border-radius:4px"><img src="' . esc_url(get_template_directory_uri()) .'/image/StockSnap_LTYITHITMXBlueFireworks800.webp" alt="" class="wp-image-666"/></figure>
			<!-- /wp:image -->
			...
			<figure class="wp-block-image size-large" style="border-radius:4px"><img src="' . esc_url(get_template_directory_uri()) .'/image/StockSnap_R2GG6XFPOMLightsOnTree900.webp" alt="" class="wp-image-664"/></figure>
			<!-- /wp:image --></div>
			<!-- /wp:column --></div>
			<!-- /wp:columns --></div></div>
			<!-- /wp:cover -->',
	...
	register_block_pattern(
		'big-lights/slant-call-to-action',
		array(
			'title'      => __( 'Slanted Call to Action', 'big-lights' ),
	...
	register_block_pattern(
		'big-lights/double-call-to-action',
		array(
			'title'      => __( 'Double Call to Action', 'big-lights' ),
			'categories' => array( 'big_bob-mixed-color-patterns' ),
			'content'    => '<!-- wp:columns {"className":"bb-double-call-to-action"} -->
			<div class="wp-block-columns bb-double-call-to-action"><!-- wp:column {"className":"bb-double-call-to-action_one bb-nav-colors"} -->
			<div class="wp-block-column bb-double-call-to-action_one bb-nav-colors"><!-- wp:heading {"textAlign":"center"} -->
			<h2 class="has-text-align-center">Option 1</h2>
			<!-- /wp:heading -->
			
			<!-- wp:paragraph {"align":"center"} -->
			<p class="has-text-align-center">This call to action will appear as your navbar colors.</p>
			<!-- /wp:paragraph -->
			
			<!-- wp:buttons -->
			<div class="wp-block-buttons"><!-- wp:button {"align":"center","className":"is-style-outline"} -->
			<div class="wp-block-button aligncenter is-style-outline"><a class="wp-block-button__link">Execute</a></div>
			<!-- /wp:button --></div>
			<!-- /wp:buttons --></div>
			<!-- /wp:column -->
			
			<!-- wp:column {"className":"bb-double-call-to-action_two"} -->
			<div class="wp-block-column bb-double-call-to-action_two"><!-- wp:heading {"textAlign":"center"} -->
			<h2 class="has-text-align-center">Option 2</h2>
			<!-- /wp:heading -->
			
			<!-- wp:paragraph {"align":"center"} -->
			<p class="has-text-align-center">This call to action will appear as your body colors.</p>
			<!-- /wp:paragraph -->
	...
	register_block_pattern(
		'big-lights/three-column-footer',
		array(
			'title'      => __( 'Three Column Footer', 'big-lights' ),
	...
	register_block_pattern(
		'big-lights/high-low-images-text',
		array(
			'title'      => __( 'High Low Imgages', 'big-lights' ),
			'categories' => array( 'big_bob-images-text-patterns' ),
			...
			<figure class="wp-block-image size-large"><img src="' . esc_url(get_template_directory_uri()) .'/image/StockSnap_R2GG6XFPOMLightsOnTree900.webp" alt="" class="wp-image-525"/></figure>
			<!-- /wp:image -->
			
			<!-- wp:paragraph {"style":{"typography":{"fontSize":"14px"}}} -->
			<p style="font-size:14px"><strong>Lights on Tree</strong><br>Tricia Gray</p>
			<!-- /wp:paragraph --></div>
			<!-- /wp:column -->
			...
			<!-- wp:paragraph {"style":{"typography":{"fontSize":"14px"}}} -->
			<p style="font-size:14px"><strong>Fireworks</strong><br>Tricia Gray</p>
			<!-- /wp:paragraph -->
	...
	register_block_pattern(
		'big-lights/image-angled-overlay-text',
		array(
			'title'      => __( 'Image with Angled Overlay and Text', 'big-lights' ),
			'categories' => array( 'big_bob-nav-color-patterns' ),
	...
	register_block_pattern(
		'big-lights/images-nav-colored-strip',
		array(
			'title'      => __( 'Images and Nav Colored Strip', 'big-lights' ),
			'categories' => array( 'big_bob-mixed-color-patterns' ),
			...
			<figure class="wp-block-image size-large"><img src="' . esc_url(get_template_directory_uri()) .'/image/StockSnap_R2GG6XFPOMLightsOnTree900.webp" alt="" class="wp-image-686"/></figure>
			<!-- /wp:image --></div>
			<!-- /wp:column -->
			...
			<figure class="wp-block-image size-large"><img src="' . esc_url(get_template_directory_uri()) .'/image/StockSnap_9GN3TCBYFRVerticalFireworks900.webp" alt="" class="wp-image-687"/></figure>
			<!-- /wp:image --></div>
			<!-- /wp:column --></div>
			<!-- /wp:columns --></div>
			<!-- /wp:group -->',
	...
	register_block_pattern(
		'big-lights/restaurant-menu',
		array(
			'title'      => __( 'Restaurant Menu)', 'big-lights' ),
	...
	register_block_pattern(
		'big-lights/simple-call-to-action',
		array(
			'title'      => __( 'Simple Call to Action', 'big-lights' ),
			'categories' => array( 'big_bob-body-color-patterns' ),
	...
	register_block_pattern(
		'big-lights/full-featured-image-with-paragraph',
		array(
			'title'      => __( 'Full Featured Image', 'big-lights' ),
			'categories' => array( 'big_bob-post-patterns' ),
			'content'    => '<!-- wp:post-featured-image {"className":"is-style-bb-block-fi-full"} /-->
	...
	register_block_pattern(
		'big-lights/fit-featured-image-with-paragraph',
		array(
			'title'      => __( 'Fit Featured Image', 'big-lights' ),
			'categories' => array( 'big_bob-post-patterns' ),
			'content'    => '<!-- wp:post-featured-image {"className":"is-style-bb-block-fi-full"} /-->
