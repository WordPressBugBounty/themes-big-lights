...
function big_bob_customize_register( $wp_customize ) {
    ...
    $bb_widgets_section->title = __( 'Sidebar and Footer Blocks', 'big-lights' );
    $wp_customize->get_setting( 'header_textcolor' )->transport = 'refresh';
    $wp_customize->get_control('header_textcolor')->description = __('This controls the color of the title (not the logo).', "big-lights");
    $wp_customize->get_control('header_textcolor')->priority = -1;
    $wp_customize->get_control('header_textcolor')->label = __('Title Color', 'big-lights');
    $wp_customize->get_section( 'header_image' )->title = __('Homepage Header Media', 'big-lights');
    $wp_customize->get_section( 'header_image' )->priority = '150';
    $wp_customize->get_setting( 'header_image' )->transport = 'refresh';
    $wp_customize->get_section( 'header_image' )->description = __("The big-lights theme is designed to maximize the size of any header image 
        ...
        on your homepage.", "big-lights");
    $wp_customize->get_setting( 'header_video' )->transport = 'refresh';
    $wp_customize->get_setting( 'external_header_video' )->transport = 'refresh';
    $wp_customize->get_setting( 'custom_logo' )->transport = 'refresh';
    $wp_customize->get_control( 'custom_logo' )->description = __('If you want to change the distance of the body from the navbar, 
    then you can make the changes in the <u>Layout</u> section.', "big-lights");
    ...
    Turning this off usually looks best when <u>Center Navbar</u> has been switched on.', "big-lights");
    ...
    setting.  White or a light color works best when the theme is in bright mode.', "big-lights");
    ...
    <u>Header Media Options</u>section to OFF.", "big-lights");
    $wp_customize->get_control( 'external_header_video' )->label = __("Use a YouTube URL", "big-lights");
    ...
    'label' => __('Preloader for Featured and Header Media', 'big-lights'),
    'section' => 'title_tagline',
    'settings' => 'big_bob_preloader',
    'type' => 'radio',
    'choices' => array(
      'On' => __('On', 'big-lights'),
      'Off' => __('Off', 'big-lights'),
	),
    'priority' => 0,
    'description' => __('This turns the prelaoder on and off when featured and header media needs to be loaded.', 'big-lights'),
    ));
    ...
    'label' => __('Title Below Nav', 'big-lights'),
    'section' => 'big_bob_navigation',
    'settings' => 'big_bob_title_below_nav',
    'type' => 'radio',
    'choices' => array(
      'Big' => __('Big', 'big-lights'),
      'Small' => __('Small', 'big-lights'),
      'Logo Below Nav' => __('Logo Below Nav', 'big-lights'),
      'Big Tagline Only' => __('Big Tagline Only', 'big-lights'),
      'Small Tagline Only' => __('Small Tagline Only', 'big-lights'),
      'Off' => __('Off', 'big-lights'),
	),
    'priority' => 50,
    ...
    <u>Center Navbar</u> in the <u>Navigation</u> section.', 'big-lights'),
    ));
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'big_bob_foreground_color_NF', array(
        'label'        => __('Navbar and Footer Foreground Color', 'big-lights'),
        'section'    => 'colors',
		'settings'   => 'big_bob_foreground_color_NF',
        'priority' => -5,
        'description'   => __('This will change the color behind the text in the navbar and footer.', 'big-lights'),
	)));
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'big_bob_link_color_NF', array(
        'label'        => __('Navbar and Footer Link Color', 'big-lights'),
        'section'    => 'colors',
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'big_bob_link_hover_color_NF', array(
        'label'        => __('Navbar and Footer Link Hover Color', 'big-lights'),
        'section'    => 'colors',
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'big_bob_text_color_NF', array(
        'label'        => __('Navbar and Footer Text and Border Color', 'big-lights'),
        'section'    => 'colors',
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'big_bob_foreground_color', array(
        'label'        => __('Body and Sidebar Foreground Color', 'big-lights'),
        'section'    => 'colors',
		'settings'   => 'big_bob_foreground_color',
        'priority' => -5,
        'description'   => __('This will change the color behind the text in the body and sidebar.', 'big-lights'),
	)));
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'big_bob_background_color', array(
        'label'        => __('Background Color', 'big-lights'),
        'section'    => 'colors',
		'settings'   => 'big_bob_background_color',
        'priority' => -5,
        'description'   => __('This will change the color behind everything.', 'big-lights'),
	)));
    ...
    $wp_customize->add_setting( 'big_bob_menu_button_icon_color', array(
        'default' => '100',
        'type' => 'theme_mod',
    ...
    $wp_customize->add_control( 'big_bob_menu_button_icon_color', array(
        'type' => 'range',
        'section' => 'colors',
        'label' => __( 'Menu Icon Darkness', 'big-lights' ),
        'description' => '',
        'priority' => 0,
        'input_attrs' => array(
                'min' => 0,
        ...
        'description'   => __('This chages darkness of hamburger icon and close icon 
        for the menu button in the navbar for small screens.', 'big-lights'),
    ));

    $wp_customize->selective_refresh->add_partial( 'big_bob_menu_button_icon_color', array(
        'render_callback' => 'big_bob_add_bright',
    ) );
    ...
    $wp_customize->add_control( 'big_bob_range_home_nav_ti', array(
        'type' => 'range',
        'section' => 'colors',
        'label' => __( 'Home Navbar and Footer Opacity', 'big-lights' ),
        'description' => '',
        'priority' => 0,
        'input_attrs' => array(
                'min' => 0,
    ...
    $wp_customize->add_control( 'big_bob_range_nav_ti', array(
        ...
        'priority' => 10,
        'section' => 'colors',
        'label' => __( 'Navbar and Footer Opacity', 'big-lights' ),
        'description' => '',
        'priority' => 0,
        'input_attrs' => array(
                'min' => 0,
        ...
        'description'   => __('This is the opacity for foreground color at the top of the page
        for the rest of your pages.', 'big-lights'),
    ));
    ...
    $wp_customize->add_control( 'big_bob_range_sn', array(
        'type' => 'range',
        'section' => 'colors',
        'label' => __( 'Scrolled Navbar Opacity', 'big-lights' ),
        'description' => '',
        'priority' => 0,
        'input_attrs' => array(
                'min' => 0,
        ...
        'description'   => __('This is the opacity for the navbar after it has scrolled down the screen.', 'big-lights'),
    ));
    ...
    $wp_customize->add_control( 'big_bob_range_sb', array(
        'type' => 'range',
        'section' => 'colors',
        'label' => __( 'Body Opacity', 'big-lights' ),
        'description' => '',
        'priority' => 0,
        'input_attrs' => array(
                'min' => 0,
        ...
        'description'   => __('This is the opacity for foreground color for the body, sidebar, and footer.', 'big-lights'),
    ));
    ...
    $wp_customize->add_control( 'big_bob_range_tile_large_screen', array(
        ...
        'label' => __( 'Space from Top for Tiled Page Body on Large Screens', 'big-lights' ),
        'priority' => -3,
        'input_attrs' => array(
                'min' => 0,
                'max' => 300,
    ...
    $wp_customize->add_control( 'big_bob_range_tile_tablet', array(
        'type' => 'range',
        'section' => 'big_bob_body_style',
        'label' => __( 'Space from Top for Tiled Page Body on Tablets', 'big-lights' ),
        'priority' => -3,
        'input_attrs' => array(
                'min' => 0,
                'max' => 300,
        ...
        on tablet sized screens.', 'big-lights'),
    ));
    ...
    $wp_customize->add_control( 'big_bob_range_tile_phone', array(
        'type' => 'range',
        'section' => 'big_bob_body_style',
        'label' => __( 'Space from Top for Tiled Page Body on Phones', 'big-lights' ),
        'priority' => -3,
        'input_attrs' => array(
                'min' => 0,
                'max' => 300,
        ...
        'description'   => __('This sets the distance between the body of a tiled page (post style) and the top of the page
        on phone sized screens.', 'big-lights'),
    ));
    ...
    $wp_customize->add_control( 'big_bob_range_wide_large_screen', array(
        'type' => 'range',
        'section' => 'big_bob_body_style',
        'label' => __( "Space from Top for Big Page Body on Large Screens", 'big-lights' ),
        'priority' => -1,
        'input_attrs' => array(
                'min' => 0,
                'max' => 300,
    ...
    $wp_customize->add_control( 'big_bob_range_wide_tablet', array(
        'type' => 'range',
        'section' => 'big_bob_body_style',
        'label' => __( 'Space from Top for Big Page Body on Tablets', 'big-lights' ),
        'priority' => -1,
        'input_attrs' => array(
                'min' => 0,
                'max' => 300,
    ...
    $wp_customize->add_control( 'big_bob_range_wide_phone', array(
        'type' => 'range',
        'section' => 'big_bob_body_style',
        'label' => __( 'Space from Top for Big Page Body on Phones', 'big-lights' ),
        'priority' => -1,
        'input_attrs' => array(
                'min' => 0,
                'max' => 300,
    ...
    $wp_customize->add_setting('big_bob_background_shadow', array(
        'default'     => 'Link Color Backlight',
        'transport'   => 'refresh',
        'sanitize_callback' => 'big_bob_checkMediaFit_backlight',
    ));
    
    $wp_customize->add_control('big_bob_background_shadow', array(
    'label' => 'Shadow Halo and Link Color Backlight',
    'section' => 'colors',
    'settings' => 'big_bob_background_shadow',
    'type' => 'radio',
    'choices' => array(
        'Shadow' => __('Shadow', 'big-lights'),
        'Link Color Backlight' => __('Link Color Backlight', 'big-lights'),
        'Off' => __('Off', 'big-lights'),
    ),
    'priority' => 0,
    ...
    behind the hamburger menu site title.', 'big-lights'),
    ));
    ...
    The borders will be added around the body, sidebar, and footer.', 'big-lights'),
    ));
    ...
    There is no shadow effect available if a logo is displayed.', 'big-lights'),
    ));
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'big_bob_link_color', array(
        'label'        => __('Body Link Color', 'big-lights'),
        'section'    => 'colors',
		'settings'   => 'big_bob_link_color',
        'priority' => -1,
        'description'   => __('This  will change the color of all the body links.', 'big-lights'),
	)));
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'big_bob_link_hover_color', array(
        'label'        => __('Body Link Hover Color', 'big-lights'),
        'section'    => 'colors',
		'settings'   => 'big_bob_link_hover_color',
        'priority' => -1,
        'description'   => __('This  will change the hover color of all the body links.', 'big-lights'),
	)));
    ...
    $wp_customize->add_setting('big_bob_menu_background_color', array(
        'default'     => '#680f0f',
		'transport'   => 'refresh',
		'sanitize_callback' => 'sanitize_hex_color_no_hash',
    ));

    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'big_bob_menu_background_color', array(
        'label'        => __('Menu Background Color', 'big-lights'),
        'section'    => 'colors',
		'settings'   => 'big_bob_menu_background_color',
        'priority' => -1,
        'description'   => __('This  will change the background color of all the menu button.', 'big-lights'),
	)));

    $wp_customize->selective_refresh->add_partial( 'big_bob_menu_background_color', array(
        'render_callback' => 'big_bob_customizer_css',
    ) );
    ...
    'label' => __('Set Header Media to Background', 'big-lights'),
    ...
    'priority' => 0,
    'description' => __('Turning this on will cause the header media to stay in place and the text to scroll over the top of the media.', 'big-lights'),
	));
    ...
    'label' => __('Show Header Video On Mobile', 'big-lights'),
    'section' => 'header_image',
    ...
    The item loaded (image or video) is based on the width when the site loads.', 'big-lights'),
    ));
    ...
    'priority' => 0,
    'description' => __('Fills the header image across the entire screen.', 'big-lights'),
    ));
    ...
    on the window size, some of the image may be cut off.', 'big-lights'),
    ));
    ...
    when the <u>Title Below Nav</u> contorl in the Navigation section is switched off.', 'big-lights'),
    ));
    ...
    'priority' => 0,
    'description' => __('This places the bacground image over the background video.', 'big-lights'),
    ));
    ...
    $wp_customize->add_section('big_bob_navigation', array(
        'title'      => __('Navigation', 'big-lights'),
        'priority'   => 30,
        'description' => __('If you want to change the distance of the body from the navbar,
        then you can make the changes in the <u>Layout</u> section.', 'big-lights'),
    ));
    ...
    'label' => __('Sticky Sidebar', 'big-lights'),
    'section' => 'big_bob_navigation',
    ...
    This feature is not available on all browsers.', 'big-lights'),
    ));
    ...
    'label' => __('Sticky Title On Mobile', 'big-lights'),
    'section' => 'big_bob_navigation',
    ...
    dsiplayed regarless of the status of this control.', 'big-lights'),
    ));

    $wp_customize->add_section('big_bob_body_style', array(
        'title'      => __('Layout', 'big-lights'),
        'priority'   => 30,
    ));
    ...
    'label' => __('Header Space for Featured Media', 'big-lights'),
    'section' => 'big_bob_body_style',
    'settings' => 'big_bob_highlight_feature_image',
    'type' => 'radio',
    'choices' => array(
        'On' => __('On', 'big-lights'),
        'Featured Images Only' => __('Featured Images Only', 'big-lights'),
        'Off' => __('Off', 'big-lights'),
	),
    'priority' => 10,
    ...
    it is best to leave it in the <u>Featured Images Only</u> position.", 'big-lights'),
    ));
    ...
    'label' => __('Page Titles', 'big-lights'),
    'section' => 'big_bob_body_style',
    ...
    best to reset both controls to <u>Featured Images Only</u>.", 'big-lights'),
    ));
    ...
    'label' => __('Excerpt Mode', 'big-lights'),
    'section' => 'big_bob_body_style',
    ...
    for the search results page.", 'big-lights'),
    ));
    ...
    'label' => __('Post Page Featured Image', 'big-lights'),
    'section' => 'big_bob_body_style',
    ...
    'priority' => 0,
    'description' => __("This will show your featured images on your posts and archive pages.", 'big-lights'),
    ));
    ...
    'label' => __('Rounded Corners', 'big-lights'),
    'section' => 'big_bob_body_style',
    ...
    'priority' => -1,
    'description' => __("This will create rounded corners for groups, images, and some other blocks.", 'big-lights'),
    ));
    ...
    'label' => __('No Sidebar for Static Pages', 'big-lights'),
    'section' => 'big_bob_body_style',
    'settings' => 'big_bob_blog_sidebar_only',
    'type' => 'radio',
    'choices' => array(
        'Home Only' => __('Home Only', 'big-lights'),
        'Except Home' => __('Except Home', 'big-lights'),
        'Off' => __('Off', 'big-lights'),
	),
    'priority' => -1,
    ...
    you choose <u>Home Only</u> or <u>Except Home</u>, your homepage must be defined as a static page in <u>Homepage Settings</u>.", 'big-lights'),
    ));

    $wp_customize->add_section('big_bob_background_video', array(
        'title' => __('Background Media', 'big-lights'),
        'priority'   => 90,
        'description'  => __('You can use this section to set mobile friendly background images and videos
        into different areas of your site, inlcluding area not covered by header media and featured media.', 'big-lights'),
    ));
    ...
    $wp_customize->add_control(new WP_Customize_Media_Control($wp_customize, 'big_bob_background_image_media', array(
        ...
        'label' => __('Load a Background Image.', 'big-lights'),
        'mime_type' => 'image',
        'priority' => -1,
        ...
        pages set as <i>Big Pages</i> in the <u>Layout</u> section.', 'big-lights'),
    )));
    ...
    $wp_customize->add_control(new WP_Customize_Media_Control($wp_customize, 'big_bob_background_video_media', array(
        ...
        'label' => __('Load a Background Video.', 'big-lights'),
        'mime_type' => 'video',
        'priority' => 0,
    ...
    'label' => __('Show Footer', 'big-lights'),
    'section' => 'big_bob_body_style',
    'settings' => 'big_bob_show_footer',
    'type' => 'radio',
    'choices' => array(
        'On' => __('On', 'big-lights'),
        'Remove Attribution Only' => __('Remove Attribution Only', 'big-lights'),
        'Off' => __('Off', 'big-lights'),
	),
    'priority' => 100,
    'description' => __("Turning this off will completely remove the footer and the back to top button.", 'big-lights'),
    ));
	...
	$wp_customize->add_section( 'big_bob_fonts' , array(
		'title'    => __('Typography','big-lights'),
		'priority' => 50,
        ...
        font names then your fonts will be set to default and will be hosted locally.", 'big-lights'),
	) );
    // Add settings
	$wp_customize->add_setting( 'big_bob_fonts_main_title', array(
        'default'           => __( 'Special Elite', 'big-lights' ),
   ...
   $wp_customize->add_control( new WP_Customize_Control(
       ...
       'big_bob_fonts_main_title',
           array(
               'label'    => __( 'Title', 'big-lights' ),
               'section'  => 'big_bob_fonts',
               'settings' => 'big_bob_fonts_main_title',
               'type'     => 'text',
               'description' => __("If this is left blank, then headings will used as the title font.", 'big-lights'),
           )
       )
   );
   ...
   $wp_customize->add_control( new WP_Customize_Control(
       ...
       'big_bob_fonts_paragraph',
           array(
               'label'    => __( 'Paragraph and Miscellaneous', 'big-lights' ),
               'section'  => 'big_bob_fonts',
   ...
   $wp_customize->add_control( new WP_Customize_Control(
       ...
       'big_bob_fonts_misc',
           array(
               'label'    => __( 'Main Menus', 'big-lights' ),
               'section'  => 'big_bob_fonts',
   ...
   $wp_customize->add_setting('big_bob_center_nav', array(
    ...
    'label' => __('Center Navbar', 'big-lights'),
    'section' => 'big_bob_navigation',
    ...
    if it is being shown.  If you want to change the distance of the body from the navbar,
    then you can make the changes in the <u>Layout</u> section.", 'big-lights'),
    ));
    ...
    'label' => __('Menu Size', 'big-lights'),
    'section' => 'big_bob_navigation',
    'settings' => 'big_bob_menu_size',
    'type' => 'radio',
    'choices' => array(
        'Small' => __('Small', 'big-lights'),
        'Medium' => __('Medium', 'big-lights'),
        'Large' => __('Large', 'big-lights'),
    ),
    'priority' => 100,
    'description' => __("This will change the size of the menu items in your navbar.  
    If you want to change the distance of the body from the navbar, 
    then you can make the changes in the <u>Layout</u> section.", 'big-lights'),
    ));
    ...
    $wp_customize->add_setting( 'big_bob_uncentered_menu_from_top', array(
        'default' => '-4',
        'type' => 'theme_mod',
        'capability' => 'edit_theme_options',
        'transport' => 'refresh',
    ...
    $wp_customize->add_control( 'big_bob_uncentered_menu_from_top', array(
        'type' => 'range',
        'section' => 'big_bob_navigation',
        'label' => __( 'Distance of Right Aligned Menu Items from Top', 'big-lights' ),
        'description' => '',
        'priority' => 90,
        'input_attrs' => array(
                'min' => -20,
        ...
        'description'   => __('This control determines how far the menu items in the navbar is from the top
        when it is not centered and on a wide screen.', 'big-lights'),
    ));

    $wp_customize->selective_refresh->add_partial( 'big_bob_uncentered_menu_from_top', array(
        'render_callback' => 'big_bob_center_nav',
    ) );

    $wp_customize->add_setting( 'big_bob_scrolled_uncentered_menu_from_top', array(
        'default' => '29',
        'type' => 'theme_mod',
        'capability' => 'edit_theme_options',
        'transport' => 'refresh',
    ...
    $wp_customize->add_control( 'big_bob_scrolled_uncentered_menu_from_top', array(
        'type' => 'range',
        'section' => 'big_bob_navigation',
        'label' => __( 'Distance of Scrolled Right Aligned Menu Items from Top', 'big-lights' ),
        'description' => '',
        'priority' => 90,
        'input_attrs' => array(
                'min' => 20,
        ...
        'description'   => __('This control determines how far the menu items in the navbar is from the top
        when it is not centered and on a wide screen after it has scrolled down the screen.', 'big-lights'),
    ));

    $wp_customize->selective_refresh->add_partial( 'big_bob_scrolled_uncentered_menu_from_top', array(
        'render_callback' => 'big_bob_center_nav',
    ) );

    $wp_customize->add_setting( 'big_bob_menu_button_tablet', array(
        'default' => '36',
        'type' => 'theme_mod',
        'capability' => 'edit_theme_options',
        'transport' => 'refresh',
    ...
    $wp_customize->add_control( 'big_bob_menu_button_tablet', array(
        'type' => 'range',
        'section' => 'big_bob_navigation',
        'label' => __( 'Distance of Menu Button from Top in Tablet', 'big-lights' ),
        'description' => '',
        'priority' => 90,
        'input_attrs' => array(
                'min' => 0,
        ...
        'description'   => __('This control determines how far the menu buttom in the navbar on tablets.
        This is used regardles of whether or not the menu items are centered.', 'big-lights'),
    ));

    $wp_customize->selective_refresh->add_partial( 'big_bob_menu_button_tablet', array(
        'render_callback' => 'big_bob_center_nav',
    ) );

    $wp_customize->add_setting( 'big_bob_scrolled_menu_button_tablet', array(
        'default' => '30',
        'type' => 'theme_mod',
        'capability' => 'edit_theme_options',
        'transport' => 'refresh',
    ...
    $wp_customize->add_control( 'big_bob_scrolled_menu_button_tablet', array(
        'type' => 'range',
        'section' => 'big_bob_navigation',
        'label' => __( 'Distance of Scrolled Menu Button from Top in Tablet', 'big-lights' ),
        'description' => '',
        'priority' => 90,
        'input_attrs' => array(
                'min' => 0,
        ...
        'description'   => __('This control determines how far the menu buttom in the navbar on tablets 
        after it has scrolled down the screen.
        This is used regardles of whether or not the menu items are centered.', 'big-lights'),
    ));

    $wp_customize->selective_refresh->add_partial( 'big_bob_scrolled_menu_button_tablet', array(
        'render_callback' => 'big_bob_center_nav',
    ) );

    $wp_customize->add_setting( 'big_bob_menu_button_phone', array(
        'default' => '30',
        'type' => 'theme_mod',
        'capability' => 'edit_theme_options',
        'transport' => 'refresh',
    ...
    $wp_customize->add_control( 'big_bob_menu_button_phone', array(
        'type' => 'range',
        'section' => 'big_bob_navigation',
        'label' => __( 'Distance of Menu Button from Top in Phone', 'big-lights' ),
        'description' => '',
        'priority' => 90,
        'input_attrs' => array(
                'min' => 0,
        ...
        'description'   => __('This control determines how far the menu buttom in the navbar on phones. 
        The phone navbar is always small, so only one distance needs to be set.
        This is used regardles of whether or not the menu items are centered.', 'big-lights'),
    ));

    $wp_customize->selective_refresh->add_partial( 'big_bob_menu_button_phone', array(
        'render_callback' => 'big_bob_center_nav',
    ) );
    ...
    'label' => __('Menu Spacing', 'big-lights'),
    'section' => 'big_bob_navigation',
    ...
    'priority' => 100,
    'description' => __("This will change the spacing between your menu items.", 'big-lights'),
    ));
    ...
    'label' => __('Underline Current Page', 'big-lights'),
    'section' => 'big_bob_navigation',
    ...
    It may be helpful to turn this off if you are creating a one page website.", 'big-lights'),
    ));
    ...
    'label' => __('Add Tagline When Title is in Navbar', 'big-lights'),
    'section' => 'big_bob_navigation',
    ...
    function big_bob_checkMediaFit_backlight($input) {
        $valid = array(
            'Shadow' => 'Shadow',
            'Link Color Backlight' => 'Link Color Backlight',
            'Off' => 'Off',
        );
...
function big_bob_customizer_css()
{
        ...
        $bb_menu_background = get_theme_mod('big_bob_menu_background_color', '#680f0f');
        $bb_menu_background = str_replace("#", "", $bb_menu_background);
        ?>
         <style type="text/css">
                ...
                @media screen and (max-width: 1064px) {
                    #bb-toggle {
                        background: #<?php echo esc_attr($bb_menu_background); ?> !important;
                    }
                }
...
function big_bob_set_nav() {
    /*Always set the menu button*/ 
    $BBMBT = get_theme_mod('big_bob_menu_button_tablet', '36');
    $BBSMBT = get_theme_mod('big_bob_scrolled_menu_button_tablet', '30');
    $BBMBP = get_theme_mod('big_bob_menu_button_phone', '30');
    ?>
        <style type="text/css">
            /*scrolled menu items*/
            @media screen and (max-width: 1064px) {
                #bb-toggle {
	                top: <?php echo esc_attr($BBMBT)?>px;
                }
                .bb-scrolled #bb-toggle {
                    top: <?php echo esc_attr($BBSMBT)?>px;
                }
            }
            @media screen and (max-width: 600px) {
                #bb-toggle {
                    top: <?php echo esc_attr($BBMBP)?>px;
                }
                .bb-scrolled #bb-toggle {
                    top: <?php echo esc_attr($BBMBP)?>px;
                }
    ...
    if (is_admin_bar_showing()) {
        ...
        ?>
         <style type="text/css">
            ...
            @media screen and (max-width: 1064px) {
                #bb-toggle {
	                top: <?php echo esc_attr($BBMBT32)?>px;
                }
                .bb-scrolled #bb-toggle {
                    top: <?php echo esc_attr($BBSMBT32)?>px;
                }
            }
            @media screen and (max-width: 782px) {
                #bb-toggle {
	                top: <?php echo esc_attr($BBMBT46)?>px;
                }
                .bb-scrolled #bb-toggle {
                    top: <?php echo esc_attr($BBSMBT46)?>px;
                }
            }
            @media screen and (max-width: 600px) {
                #bb-toggle {
                    top: <?php echo esc_attr($BBMBP46)?>px;
                }
                .bb-scrolled #bb-toggle {
                    top: <?php echo esc_attr($BBMBP)?>px;
                }
    ...
    if (get_theme_mod('big_bob_center_nav', "On") == "On") {
        ...
        $UMFT = get_theme_mod('big_bob_uncentered_menu_from_top', '-4');
        $SUMFT = get_theme_mod('big_bob_scrolled_uncentered_menu_from_top', '29');
        ?>
        <style type="text/css">
            @media screen and (min-width: 1065px) {
                #site-navigation ul {
                    margin-top: <?php echo esc_attr($UMFT)?>px !important;
                    margin-bottom: 0px;
                    transition: 1200ms ease;
                }
                #site-navigation.bb-scrolled ul {
            ...
            @media screen and (min-width: 1065px) {
                .bb-scrolled .nav-menu {
                    padding-top: <?php echo esc_attr($SUMFT)?>px;
                }
            }
        </style>
        <?php
...
function big_bob_change_fonts_title() {
    if (get_theme_mod('big_bob_fonts_title', 'Special Elite') != "") {
        $big_bob_url = get_theme_mod('big_bob_fonts_title', 'Special Elite'); ?>
			<style type="text/css">
...
function big_bob_change_fonts_main_title() {
    if (get_theme_mod('big_bob_fonts_main_title', 'Special Elite') != "") {
        $big_bob_url = get_theme_mod('big_bob_fonts_main_title', 'Special Elite'); ?>
			<style type="text/css">
...
function big_bob_change_fonts_paragraph() {
    if (get_theme_mod('big_bob_fonts_paragraph', "Special Elite") != "") {
        $big_bob_url = get_theme_mod('big_bob_fonts_paragraph', "Special Elite"); ?>
			<style type="text/css">
                body,
...
function big_bob_change_fonts_misc() {
    if (get_theme_mod('big_bob_fonts_misc', 'Special Elite') != "") {
        $big_bob_url = get_theme_mod('big_bob_fonts_misc', 'Special Elite'); ?>
			<style type="text/css">
                #primary-menu li,
                #bb-sidebar-menu li {
...
function big_bob_add_bright() {
        $TCNF = get_theme_mod('big_bob_text_color_NF', '#ffffff');
        $FLHCNF = get_theme_mod('big_bob_link_hover_color_NF', '#eeee22');
        $FLCNF = get_theme_mod('big_bob_link_color_NF', '#ffffff');
        $FCNF = get_theme_mod('big_bob_foreground_color_NF', '#680f0f');
        ...
        $BBMBIC = get_theme_mod('big_bob_menu_button_icon_color', '100');
        ?>
			<style type="text/css">
                body {
                ...
                #bb-menu-icon,
                #bb-close-icon {
                    filter: invert(<?php echo esc_attr($BBMBIC)?>%);
                }
                <?php
                if (get_theme_mod('big_bob_borders', 'On') == "On") {
                ?>
...
function big_bob_add_shadow() {
    if( get_theme_mod( 'big_bob_background_shadow', 'Link Color Backlight' ) == 'Shadow' ) {
		?>
			<style type="text/css">
                .bb-site-title-top {
		...
		<?php
    } else if ( get_theme_mod( 'big_bob_background_shadow', 'Link Color Backlight' ) == 'Link Color Backlight' ) {
        $bb_link = get_theme_mod('big_bob_link_color', '#eeee22');
        $bb_link = str_replace("#", "", $bb_link);
		?>
			<style type="text/css">
                .bb-site-title-top {
                    text-shadow: 0 0 25px #<?php echo esc_attr($bb_link)?>;
                    transition: 1200ms ease;
                }
                .bb-alignleftstyle,
                .bb-alignrightstyle,
                ...
                #site-navigation.bb-scrolled
                {
                    box-shadow: 0 0 25px #<?php echo esc_attr($bb_link)?>;
                }
                @media screen and (max-width: 1064px) {
                    #bb-popout {
                        box-shadow: 0 0 25px #<?php echo esc_attr($bb_link)?>;
    ...
    if (get_theme_mod('big_bob_title_shadow', 'On') == 'Off') {
		?>
			<style type="text/css">
                .bb-site-title-top {
...
function big_bob_turn_on_wide_when_centered() {
    if (get_theme_mod('big_bob_wide_when_centered', 'Off') == 'On') {
        ...
        if ( !( (get_theme_mod('big_bob_highlight_feature_image', 'Featured Images Only') == 'On') 
            ...
            $bb_FTLS = get_theme_mod('big_bob_range_wide_large_screen', '210');
            $bb_FTT = get_theme_mod('big_bob_range_wide_tablet', '180');
            $bb_FTP = get_theme_mod('big_bob_range_wide_phone', '200');
            ?>
            <style type="text/css">
                .bb-topPageSpace {
...
function big_bob_measure_tile_from_top() {
    $bb_TLS = get_theme_mod('big_bob_range_tile_large_screen', '220');
    $bb_TT = get_theme_mod('big_bob_range_tile_tablet', '150');
    $bb_TP = get_theme_mod('big_bob_range_tile_phone', '170');
    ?>
    <style type="text/css">
        .bb-top-padding {
...
function big_bob_phone_is_sticky() {
    if( get_theme_mod( 'big_bob_sticky_navbar_on_mobile', 'On' ) == 'Off' ) {
		?>
			<style type="text/css">
                @media screen and (max-width: 1064px) {
                    .bb-fixed-top {
